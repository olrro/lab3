<div class="container my-5">
  <h1 class="mt-5">Поиск <a href="/search#start" id="start"><i class="fas fa-search"></i></a></h1>
  <p class="lead mb-5">
      Ищите материалы в нашей коллекции для обучения студентов. Результаты поиска выводятся мгновенно.
      Запрос не должен быть пустым, превышать 150 символов и быль меньше 5 символов.
    </p>
    ...
    <form action="/search" method="POST">
      ...
      <div class="col-xl-10">
        ...
        <input type="text" name="request" class="form-control form-control-lg" id="searchField" placeholder="Основные предметы" autofocus required>
